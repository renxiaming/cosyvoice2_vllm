...
class InputBatch:
    ...
    def add_request(
        ...
        if request.prompt_token_ids is not None:
            ...
            self.is_token_ids_tensor[req_index, :num_prompt_tokens] = True
        else:
            self.is_token_ids_tensor[req_index, :num_prompt_tokens] = False
        if request.prompt_embeds is not None:
            self.req_prompt_embeds[req_index] = request.prompt_embeds
        self.token_ids_cpu[req_index,
                           start_idx:end_idx] = request.output_token_ids
        self.is_token_ids_tensor[req_index, start_idx:end_idx] = True
    ...
    def swap_states(self, i1: int, i2: int) -> None:
        ...
        tmp_mask = self.is_token_ids_tensor[i1, ...].clone()
        self.is_token_ids_tensor[i1, ...] = self.is_token_ids_tensor[i2, ...]
        self.is_token_ids_tensor[i2, ...] = tmp_mask
    ...
    def condense(self) -> None:
        ...
        while empty_req_indices:
            ...
            self.is_token_ids_tensor[
                empty_index, :num_tokens] = self.is_token_ids_tensor[
                    last_req_index, :num_tokens]
